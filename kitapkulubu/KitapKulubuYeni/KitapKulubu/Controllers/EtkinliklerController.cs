...
namespace KitapKulubu.Controllers
{
    public class EtkinliklerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EtkinlikID,etkinlikBaslik,etkinlikIcerik,bitisTar,baslangicTar,resim")] Etkinlikler etkinlikler)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EtkinlikID,etkinlikBaslik,etkinlikIcerik,bitisTar,baslangicTar,resim")] Etkinlikler etkinlikler)
        {
            if (ModelState.IsValid)
            {
